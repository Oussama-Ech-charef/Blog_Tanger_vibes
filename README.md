...
│   ├── explor.php                Explore page with category filtering
...
│   ├── edete.php                 Edit post form with pre-filled data
│   ├── delet.php                 Delete post handler with role-based permissions
...
└── sql/
    └── scripet.sql               Database schema and default category data
```
...
2. Create the database by running `sql/scripet.sql` in your MySQL client.
